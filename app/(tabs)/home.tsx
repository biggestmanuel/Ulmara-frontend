...
// Realistic transaction mock data until user creates live txs
      ...
      >
        ...
        <View style={styles.topHeader}>
          ...
          <View style={styles.headerIcons}>
            {/* Customer service headset icon — commented out for now */}
            {/*
            <Pressable style={[styles.iconButton, { backgroundColor: colors.surface }]} hitSlop={10}>
...
const styles = StyleSheet.create({
  ...
  // Squircles: squared with curved edges
  squircleBtn: {
    width: 60,
    height: 60,
    borderRadius: 18,
